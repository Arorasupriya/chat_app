...
class ColorConstant {
  ...
  //currently used colors theme
  static const Color gradientDarkColor = Color(0xff2193b0);
  static const Color gradientLightColor = Color(0xff6dd5ed);
  ...
  static late Color iconColorSM;
  static late Color textThirdColor;
}
